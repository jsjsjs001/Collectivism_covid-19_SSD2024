...
df = wb.data.DataFrame('SI.POV.GINI', time=range(2015, 2021), labels= True)
...
'Country': 'Country name', 'SI_POV_GINI': 	'The Gini index measures the extent to which the distribution of income or consumption among individuals or households within an economy deviates from a perfectly equal distribution.'}
...
path = '../../covid_19_delo/Serban_a/country_level_data/Country_measures_gini.sav'
