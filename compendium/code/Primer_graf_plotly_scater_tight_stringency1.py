...
y="StringencyIndex_Average_FD_po_6_22", text="Three_Letter_Country_Code", 
log_x=True, size_max=100, trendline="ols", color="All_Less_Vaccinated_Later_Never")
fig.update_traces(textposition='top center')
fig.update_layout(title_text='Tightnes & Stringency_do_6_22', title_x=0.5)
fig.show()
