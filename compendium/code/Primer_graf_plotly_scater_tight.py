...
fig = px.scatter(df2, x="Tightness_adjusted_scale", 
y="LIMITATION_INDIVIDUAL_FREEDOMS_JUSTIFIED", text="Three_Letter_Country_Code", 
log_x=True, size_max=100, trendline="ols")
...
# 'False_Viruses': 'Viruses have been produced in government laboratories to control our freedom', 'False_Cancer': 'The cure for cancer exists but is hidden from the public by commercial interests', 'False_Climate': 'Climate change is for the most part caused by natural cycles rather than human activities', 'False_Soc_Sci': 'The methods used by the natural sciences and the social sciences are equally scientific', 'StringencyIndex_Average_FD_do_6_22': 'Stringency Index Average FD_do_6_22', 'StringencyIndex_Average_FD_po_6_22': 'Stringency Index Average FD po 6_22', 'Mobility_Total': 'retail and recreation  grocery and pharmacy  parks  transit stations  workplaces  residential'}
#plt.show()
