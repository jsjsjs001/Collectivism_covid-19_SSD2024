...
data= df1[["SUPPOSE_NATIONAL_GOVERNMENT" , 'SATISFACTION_PANDEMIC_MEASURES' , 
'LIMITATION_INDIVIDUAL_FREEDOMS_JUSTIFIED', 'Everyone_should_get_vaccinated_it_is_civic_duty',
